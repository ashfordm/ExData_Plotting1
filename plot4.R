...
par(mfrow=c(2,2))
##subplot4.1
with(dfile,plot(timestamp,Global_active_power/1000, type="l", xlab="", ylab="Global Active Power"))
##subplot4.2
with(dfile,plot(timestamp,Voltage, type="l", xlab="datetime", ylab="Voltage"))
##subplot4.3
with(dfile,plot(timestamp,Sub_metering_1, type="l", xlab="", ylab="Energy sub metering"))
with(dfile,lines(timestamp,Sub_metering_2,col="red"))
with(dfile,lines(timestamp,Sub_metering_3,col="blue"))
legend("topright", col=c("black","red","blue"), c("Sub_metering_1                                    ","Sub_metering_2                                    ", "Sub_metering_3                                    "),lty=c(1,1), bty="n", cex=.5) 
#subplot4.4
with(dfile,plot(timestamp,Global_reactive_power/1000, type="l", xlab="datetime", ylab="Global_reactive_power"))
